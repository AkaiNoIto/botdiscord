...
const SettingsSchema = new mongoose.Schema({ guildId: { type: String, required: true, unique: true }, welcomeChannel: String, welcomeMessage: String, coinsPerMessage: Number, coinsPerVoiceMinute: Number, levelUpChannel: String, levelingEnabled: Boolean, autoModEnabled: Boolean, leaveChannel: String, leaveMessage: String, ticketCategory: String, ticketAdminRole: String, ticketLogChannel: String, logMsgSend: String, logMsgEdit: String, logMsgDelete: String, logVoice: String, adChannelId: String, adRoleId: String, adInitialPrice: Number, adRechargePrice: Number }, { strict: false });
